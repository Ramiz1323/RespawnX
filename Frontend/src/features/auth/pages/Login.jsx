        ...
        <div className="login-page-container">
            ...
            <div className="login-form-side">
                ...
                <div className="header-section">
                    ...
                    <p className="subtitle">Initialize session to access your hardware interface.</p>
                </div>
                ...
                <form className="login-form" onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <div className={`input-wrapper ${emailFocused ? 'focused' : ''}`}>
                            ...
                            <input
                                ...
                                placeholder="sys.admin@respawnx.com"
                    ...
                    <button type="submit" className="btn-submit" disabled={isSubmitting}>
                        {isSubmitting ? "Initializing..." : "Sign In"}
                        {!isSubmitting && (
            ...
            {/* Right Side: Informational/Backdrop */}
            <div className="login-info-side">
                {/* System Status Panel */}
                <div className="system-status">
                    <span className="status-item">SYS.STATUS: <span>ONLINE</span></span>
                    <span className="status-item">ENCRYPTION: <span>AES-256</span></span>
                </div>
                ...
                <div className="info-card">
                    <div className="icon-box">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" xmlns="http://www.w3.org/2000/svg">
                            {/* Robot Arm / Precision SVG */}
                            <path d="M12 22V12M12 12L7 7M12 12L17 7M7 7H3M17 7H21M7 7L10 3M17 7L14 3" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/>
                            <circle cx="12" cy="12" r="1.5" fill="currentColor"/>
                            <rect x="5" y="17" width="14" height="3" rx="1" stroke="currentColor" strokeWidth="2"/>
                        </svg>
                    </div>
                    <h2 className="card-title">Precision Engineered</h2>
                    <p className="card-desc">
                        Access your custom loadouts, hardware telemetry, and secure cloud synchronization.
                    </p>
                </div>
